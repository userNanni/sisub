...
export default function HomeHero(isVisible: { hero: boolean; steps: boolean; meals: boolean; features: boolean; cta: boolean; }) {
    return <div
      id="hero"
      className={`container mx-auto px-4 py-16 transition-all duration-500 ${isVisible.hero
