...
export default function Home() {
  const features = [
    ...
    },
    {
      ...
      description: "Sistema organizado por unidade, facilitando o controle e gestão do rancho."
    },
    {
      icon: Smartphone,
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center space-y-6 max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 leading-tight">
            Gerencie suas
            <span className="text-blue-600 block">refeições militares</span>
          </h1>
          
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Sistema inteligente para previsão de demanda do rancho militar. 
            Planeje suas refeições, reduza desperdícios e otimize a gestão alimentar da sua unidade.
          </p>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Como funciona o sistema</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <Card className="text-center border-2 hover:border-purple-200 transition-colors">
            <CardHeader>
              ...
              <CardTitle className="text-xl">3. Confirme Automaticamente</CardTitle>
            </CardHeader>
            <CardContent>
              <CardDescription className="text-base">
      ...
      <div className="bg-gray-50 py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Tipos de refeição disponíveis</h2>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Principais funcionalidades</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-blue-100 text-lg mb-8 max-w-2xl mx-auto">
            Faça parte da modernização do sistema de rancho militar. 
            Acesse agora e comece a planejar suas refeições de forma inteligente.
          </p>
